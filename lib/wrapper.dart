...
class TestRuntime {
  ...
  static Future<void> Function(HttpRequest request) onMissingStub;

  static addStub(Stub stub) {
    _stubber.stub(stub);
  }

  static Future<void> start(Iterable<StepDefinitionBase> steps,
      [Iterable<Hook> hooks]) async {
    ...
    var reporters = mapConfig['reporting'] != null && mapConfig['reporting']
        ...
        : [ProgressReporter(), TestRunSummaryReporter()];
    _stubber = Stubber(onMissingStub: onMissingStub);
