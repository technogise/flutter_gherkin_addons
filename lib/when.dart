...
class GenericWhen1<TWorld extends World,Input1> extends When1WithWorld<Input1,TWorld>{
  String _pattern;
...
GenericWhen1 when1<TWorld extends World,Input1>(String pattern,One<TWorld,Input1> step){
  return GenericWhen1<TWorld,Input1>(pattern,step);
}
class GenericWhen2<TWorld extends World,Input1,Input2> extends When2WithWorld<Input1,Input2,TWorld>{
  String _pattern;
...
GenericWhen2 when2<TWorld extends World,Input1,Input2>(String pattern,Two<TWorld,Input1,Input2> step){
  return GenericWhen2<TWorld,Input1,Input2>(pattern,step);
}
class GenericWhen3<TWorld extends World,Input1,Input2,Input3> extends When3WithWorld<Input1,Input2,Input3,TWorld>{
  String _pattern;
...
GenericWhen3 when3<TWorld extends World,Input1,Input2,Input3>(String pattern,Three<TWorld,Input1,Input2,Input3> step){
  return GenericWhen3<TWorld,Input1,Input2,Input3>(pattern,step);
}
class GenericWhen4<TWorld extends World,Input1,Input2,Input3,Input4> extends When4WithWorld<Input1,Input2,Input3,Input4,TWorld>{
  String _pattern;
...
GenericWhen4 when4<TWorld extends World,Input1,Input2,Input3,Input4>(String pattern,Four<TWorld,Input1,Input2,Input3,Input4> step){
  return GenericWhen4<TWorld,Input1,Input2,Input3,Input4>(pattern,step);
}
class GenericWhen5<TWorld extends World,Input1,Input2,Input3,Input4,Input5> extends When5WithWorld<Input1,Input2,Input3,Input4,Input5,TWorld>{
  String _pattern;
...
GenericWhen5 when5<TWorld extends World,Input1,Input2,Input3,Input4,Input5>(String pattern,Five<TWorld,Input1,Input2,Input3,Input4,Input5> step){
  return GenericWhen5<TWorld,Input1,Input2,Input3,Input4,Input5>(pattern,step);
}
